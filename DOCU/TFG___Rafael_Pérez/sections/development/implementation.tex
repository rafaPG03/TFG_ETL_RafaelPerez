...
Para la construcción de la arquitectura BI, hemos seguido un proceso ETL (\textit{Extract, Transform, Load}) que abarca desde la extracción de los datos en crudo mediante Api-Football hasta la carga en la base de datos PostgreSQL. Así que estructuraremos la explicación en tres fases: Extracción, Transformación y Carga, explicando la organización de directorios, archivos creados y conexiones entre las diferentes fases.
...
Para esta extracción se han desarrollado los siguientes \textit{scripts}, los cuales explicaremos su funcionamiento:
...
Este chatbot utiliza una clave de API de Gemini proporcionada por Google AI Studio \cite{aistudio}, que permite acceder a los modelos de inteligencia artificial de Google. En este caso se emplea el modelo Gemini 2.5 Flash, ya que proporciona un equilibrio adecuado entre precisión y velocidad de respuesta.
